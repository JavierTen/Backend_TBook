    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="">
                ...
                <div  id="selectCollection" class="ml-auto mr-3">
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function initSelectCollection(){
            ...
            $.ajax({
                url: "{!! url('restaurants/uploads/collectionsNames') !!}",
                type: 'GET',
        ...
        $('#mediaModal').on('show.bs.modal',function (event) {
            ...
            loadMedia("{!! url('restaurants/uploads/all') !!}/"+dropzoneIndex);
            initSelectCollection();
        });
        $('#selectCollection #collection_name').on('change',function () {
            loadMedia("{!! url('restaurants/uploads/all') !!}/"+$(this).val());
        })
    </script>
@endpush