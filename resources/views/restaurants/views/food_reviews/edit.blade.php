            ...
            <form id="form-project" role="form" autocomplete="off" novalidate="novalidate">
              ...
              <div class="form-group-attached p-b-20">
               ...
               <div class="row">
                  <div class="col-md-12">
                    ...
                    <label>Usuario</label>
                    {!! Form::select('users', $users, $usersSelect , ['class' => 'full-width' ,'name' => 'users' , 'data-init-plugin' => 'select2', 'id' => 'usersSelect' , 'required']) !!}
                    </div>
                  </div>
              </div>   
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group form-group-default form-group-default-select2 required">
                  <label>Usuario</label>
                  {!! Form::select('foods', $foods, $foodsSelect , ['class' => 'full-width' ,'name' => 'foods' , 'data-init-plugin' => 'select2', 'id' => 'foodsSelect' , 'required']) !!}
                  </div>
                </div>
              </div>   
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group form-group-default required" aria-required="true">
                    ...
                    {!! Form::text('rate', $review->rate,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_name_placeholder")]) !!}
                  </div> 
                </div>
                <div class="col-md-6">
              ...
              <div class="card card-default">
                  ...
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="hint" id="hint" class="summernote">{!! $review->review !!}</textarea>
                    </div>
                  </div>
              </div>
