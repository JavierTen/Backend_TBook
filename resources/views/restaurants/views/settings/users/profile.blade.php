...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($user, ['route' => ['managers.users.update', $user->id], 'method' => 'patch']) !!}
                            <div class="row">
                                @include('restaurants.views.settings.users.fields')
                            </div>
                            {!! Form::close() !!}
                            <div class="clearfix"></div>
                        </div>
    ...
    @include('restaurants.partials.modals.media_modal',['collection'=>null])
