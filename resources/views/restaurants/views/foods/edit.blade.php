      ...
      <div class="col-md-7">
        ...
        <div class="card card-transparent">
          <div class="card-body">
            ...
            {!! Form::open(['route' => ['restaurants.foods.update', $food->id], 'method' =>'POST', 'files' => true]) !!}

              <div class="form-group-attached p-b-20">
                <div class="form-group form-group-default required" aria-required="true">
                  <label>Nombre</label>
                  {!! Form::text('name', $food->name,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_name_placeholder")]) !!}
                </div>

                <div class="form-group form-group-default required" aria-required="true">
                  <label>Tamaño</label>
                  {!! Form::text('weight', $food->weight,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_address_placeholder")]) !!}
                </div>
                ...
                <div class="row clearfix">                 
                  <div class="col-md-6">
                    <div class="form-group form-group-default">
                      <label>Precio</label>
                      {!! Form::text('price', $food->price,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_latitude_placeholder")]) !!}
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group form-group-default required" aria-required="true">
                      <label>Descuento</label>
                      {!! Form::text('discount', $food->discount_price,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_longitude_placeholder")]) !!}
                    </div>
                  </div>
                </div>
                ...
                <div class="row">                 
                    ...
                    <div class="form-group form-group-default input-group">
                      ...
                      <div class="input-group-append h-c-50">
                        <span class="input-group-text transparent">
                          ...
                          @else
                          <input type="checkbox" data-init-plugin="switchery" data-size="small" data-color="primary" name="featured" id="featured"  data-switchery="true" style="display: none;"/>
                          @endif                          
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-group-default input-group">
                      ...
                      <div class="input-group-append h-c-50">
                        <span class="input-group-text transparent">         
                          @if($food->observable == 1)
                          <input type="checkbox" data-init-plugin="switchery" data-size="small" data-color="primary" checked="checked" name="observable" id="observable"  data-switchery="true" style="display: none;"/>
                        @else
                        <input type="checkbox" data-init-plugin="switchery" data-size="small" data-color="primary" name="observable" id="observable"  data-switchery="true" style="display: none;"/>
                        @endif                          
                        </span>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('categories', $categories, $categoriesSelect , ['class' => 'full-width' , 'data-init-plugin' => 'select2', 'id' => 'categoriesSelect' , 'required']) !!}
                    </div>
                  </div>
                </div>       
              ...
              <div class="card card-default">
                  ...
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="description" id="description" class="summernote">{!! $food->description !!}</textarea>
                    </div>
                  </div>
              </div>
              ...
              <div class="card card-default">
                  <div class="card-header ">
                    <div class="card-title">Ingredientes
                    </div>
                  </div>
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="ingredients" id="ingredients" class="summernote">{!! $food->ingredients !!}</textarea>
                    </div>
                  </div>
                </div>
...
<script src="{{asset('/manager/assets/js/managers/outfoods.js')}}"></script>
...
<script type="text/javascript">
  ...
  var dz_var15671147011688676454ble = $(".dropzone.image").dropzone({
      url: "{!!url('restaurants/uploads/store')!!}",
      addRemoveLinks: true,
      maxFiles: 1,
      init: function () {
      @if(isset($food) && $food->hasMedia('image'))
          dzInit(this,var15671147011688676454ble,'{!! url($food->getFirstMediaUrl('image','thumb')) !!}')
      @endif
      },
      ...
      removedfile: function (file) {
          dzRemoveFile(
              ...
              'image', '{!! isset($food) ? $food->id : 0 !!}', '{!! url("/restaurants/uplaods/clear") !!}', '{!! csrf_token() !!}'
          );
      }
  });
