      ...
      <div class="col-md-7">
        ...
        <div class="card card-transparent">
          <div class="card-body">
            ...
            {!! Form::open(['route' => ['restaurants.foods.store'], 'method' =>'POST', 'files' => true]) !!}
              ...
              <div class="form-group-attached p-b-20">
                ...
                <div class="form-group form-group-default required" aria-required="true">
                  <label>Tamaño</label>
                  {!! Form::text('weight',null,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_address_placeholder")]) !!}
                </div>
                ...
                <div class="row clearfix">                 
                  <div class="col-md-6">
                    <div class="form-group form-group-default">
                      <label>Precio</label>
                      {!! Form::text('price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_latitude_placeholder")]) !!}
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group form-group-default required" aria-required="true">
                      <label>Descuento</label>
                      {!! Form::text('discount_price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_longitude_placeholder")]) !!}
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('restaurants', $restaurants, null , ['class' => 'full-width','name' => 'drivers' , 'data-init-plugin' => 'select2', 'id' => 'restaurantsSelect' , 'required']) !!}
                    </div>
                  </div>
                </div>          
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('categories', $categories, null , ['class' => 'full-width','name' => 'drivers' , 'data-init-plugin' => 'select2', 'id' => 'categoriesSelect' , 'required']) !!}
                    </div>
                  </div>
                </div>       
              ...
              <div class="card card-default">
                  ...
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="ingredients" id="ingredients" class="summernote"></textarea>
                    </div>
                  </div>
                </div>
