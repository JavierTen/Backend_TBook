      ...
      <div class="content ">
                  ...
                  <div class="col-xl-5 col-lg-6 ">
                    ...
                    <div class="card card-transparent">
                      <div class="card-header ">
                        <div class="card-title">Preguntas Frecuentes
                        </div>
                      </div>
                      <div class="card-block">
                        <h3>Herramienta para crear Preguntas Frecuentes.</h3>
          ...
          <div class=" no-padding container-fixed-lg bg-white">
            <div class="container">
              ...
              <div class="card card-transparent">
                <div class="card-header ">
                  <div class="card-title">Listado Preguntas Frecuentes
                  </div>
                ...
                <div class="card-block">
                   @include('restaurants.partials.listing.reviews.restaurants') 
                </div>
              </div>
            </div>
          </div>
