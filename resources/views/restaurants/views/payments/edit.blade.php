              ...
              <div class="form-group-attached p-b-20">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('payments', $status, $payment->status , ['class' => 'full-width' ,'name' => 'stpaymentsatus' , 'data-init-plugin' => 'select2', 'id' => 'paymentsSelect' , 'required']) !!}
                    </div>
                  </div>
                </div> 
                ...
                <div class="form-group form-group-default required" aria-required="true">
                  <label>Methodo Pago</label>
                  {!! Form::text('method', $payment->method,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_name_placeholder")]) !!}
                </div>

                <div class="form-group form-group-default required" aria-required="true">
                  <label>Precio</label>
                  {!! Form::text('tax', $payment->price,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_name_placeholder")]) !!}
                </div>
              ...
              <div class="card card-default">
                  ...
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="description" id="description" class="summernote">{!! $payment->description !!}</textarea>
                    </div>
                  </div>
              </div>
