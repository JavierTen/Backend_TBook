              ...
              <div class="form-group-attached p-b-20">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('payments', $status, null  , ['class' => 'full-width' ,'name' => 'stpaymentsatus' , 'data-init-plugin' => 'select2', 'id' => 'paymentsSelect' , 'required']) !!}
                    </div>
                  </div>
                </div> 
                ...
                <div class="form-group form-group-default required" aria-required="true">
                  ...
                  {!! Form::text('method', null,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_name_placeholder")]) !!}
                </div>

                <div class="form-group form-group-default required" aria-required="true">
                  <label>Precio</label>
                  {!! Form::text('tax', null ,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_name_placeholder")]) !!}
                </div>
