                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/avatar.jpg" data-src="/manager/img/profiles/avatar.jpg" src="/manager/img/profiles/avatar.jpg" class="col-top">
                        </span>
                        </span>
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="/manager/img/profiles/avatar.jpg" alt="" data-src="/manager/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar.jpg">
                  </div>
