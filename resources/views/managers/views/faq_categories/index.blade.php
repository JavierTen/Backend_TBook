      ...
      <div class="content ">
            ...
            <div class=" container p-l-0 p-r-0   container-fixed-lg sm-p-l-0 sm-p-r-0" style=" height: 390px;">
              <div class="inner">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Categoria Preguntas</li>
                </ol>
                <!-- END BREADCRUMB -->
                <div class="row">
                  ...
                  <div class="col-xl-5 col-lg-6 ">
                    ...
                    <div class="card card-transparent">
                      <div class="card-header ">
                        <div class="card-title">Categoria Preguntas
                        </div>
                      </div>
                      <div class="card-block">
                        <h3>Herramienta para crear Categoria Preguntas.</h3>
          ...
          <div class=" no-padding container-fixed-lg bg-white">
            <div class="container">
              ...
              <div class="card card-transparent">
                <div class="card-header ">
                  <div class="card-title">Listado Categoria Preguntas
                  </div>
                ...
                <div class="card-block">
                   @include('managers.partials.listing.faqs.categories') 
                </div>
              </div>
            </div>
          </div>
