              ...
              <div class="form-group-attached p-b-20">
                ...
                <div class="row clearfix">                 
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-group-default required" aria-required="true">
                      ...
                      {!! Form::text('discount_price', $food->discount_price,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurant_longitude_placeholder")]) !!}
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-group-default input-group">
                      ...
                      <div class="input-group-append h-c-50">
                        ...
                        @else
                        <input type="checkbox" data-init-plugin="switchery" data-size="small" data-color="primary" name="authorization" id="authorization"  data-switchery="true" style="display: none;"/>
                        @endif                          
                        </span>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('restaurants', $restaurants, $restaurantsSelect , ['class' => 'full-width','name' => 'drivers' , 'data-init-plugin' => 'select2', 'id' => 'restaurantsSelect' , 'required']) !!}
                    </div>
                  </div>
                </div>          
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    {!! Form::select('categories', $categories, $categoriesSelect , ['class' => 'full-width','name' => 'drivers' , 'data-init-plugin' => 'select2', 'id' => 'categoriesSelect' , 'required']) !!}
                    </div>
                  </div>
                </div>       
