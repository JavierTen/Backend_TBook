          ...
          <div class="card-body">
            <form id="form-project" role="form" autocomplete="off" novalidate="novalidate">
              ...
              <div class="card card-default">
                  <div class="card-header ">
                    <div class="card-title">Pregunta
                    </div>
                  </div>
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="question" id="question" class="summernote">{!! $faq->question !!}</textarea>
                    </div>
                  </div>
              </div>
    
              <div class="card card-default p-b-20">
                  <div class="card-header ">
                    <div class="card-title">Respuesta
                    </div>
                  </div>
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    {!! Form::select('categories', $categories, $categorieSelected , ['class' => 'full-width','name' => 'categories' , 'data-init-plugin' => 'select2', 'id' => 'categoriesSelect' , 'required']) !!}
                    </div>
                  </div>
                  <div class="col-md-6">
...
<script src="{{asset('/manager/assets/js/managers/outfaqs.js')}}"></script>
