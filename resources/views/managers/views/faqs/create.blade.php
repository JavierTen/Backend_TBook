              ...
              <div class="card card-default">
                  ...
                  <div class="card-body no-scroll card-toolbar">
                    <div class="summernote-wrapper">
                              <textarea name="question" id="question" class="summernote"></textarea>
                    </div>
                  </div>
              </div>
              ...
              <div class="card card-default">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    {!! Form::select('categories', $categories, null , ['class' => 'full-width','name' => 'categories' , 'data-init-plugin' => 'select2', 'id' => 'categoriesSelect' , 'required']) !!}
                    </div>
                  </div>
                  <div class="col-md-6">
