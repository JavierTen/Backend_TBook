        ...
        <tbody>
              @foreach($faqs as $faq)
                        <tr>
                          ...
                          <td class="v-align-middle"> 
                            <a href="{{ route('managers.faqs.edit', array($faq->token)) }}"" data-original-title="Editar" style="margin:5px; color: #222222;">     
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>  
                            <a href="{{ route('managers.faqs.destroy', array($faq->sku)) }}" data-original-title="Eliminar" style="margin:5px; color: #222222;">    
