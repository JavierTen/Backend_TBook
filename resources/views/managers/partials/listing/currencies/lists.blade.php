        ...
        <tbody>
              @foreach($foods as $food)
                        <tr>
                          ...
                          <td class="v-align-middle"> 
                            <a  class="editFood" href="{{ route('managers.foods.edit', array($food->sku)) }}"" data-original-title="Editar" style="margin:5px; color: #222222;">                        
                                <input type="hidden" name="tokenFood" value="{{ $food->token }}" > 
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>  
                            <a class="destroyFood" href="{{ route('managers.foods.destroy', array($food->sku)) }}" data-original-title="Eliminar" style="margin:5px; color: #222222;">                        
                              <input type="hidden" name="tokenFood" value="{{ $food->token }}" > 
