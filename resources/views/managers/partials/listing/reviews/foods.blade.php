        ...
        <tbody>
              @foreach($reviews as $review)
                        <tr>
                          ...
                          <td class="v-align-middle"> 
                            <a href="{{ route('managers.foodreviews.edit', array($review->id)) }}"" data-original-title="Editar" style="margin:5px; color: #222222;"> 
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>  
                            <a href="{{ route('managers.foodreviews.destroy', array($review->id)) }}" data-original-title="Eliminar" style="margin:5px; color: #222222;">  
