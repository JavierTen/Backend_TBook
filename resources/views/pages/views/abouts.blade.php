             ...
             <div id="primary" class="content-area">
                  <main id="main" class="site-main">
                     <header class="about-header">
                        <img width="1934" height="734" src="assets\images\about-bg.jpeg" class="attachment-full size-full wp-post-image" alt="">
                     </header>
                        ...
                        <div class="widget widget_template_features">
                           <div class="features columns-3">
                              <div class="feature first">
                                 ...
                                 <img width="370" height="280" src="assets\images\about-column-1.jpeg" class="attachment-370x370 size-370x370 wp-post-image" alt="">
                                 </a>
                              ...
                              <div class="feature">
                                 ...
                                 <img width="370" height="280" src="assets\images\about-column-2.jpeg" class="attachment-370x370 size-370x370 wp-post-image" alt="">
                                 </a>
                                 <h3 class="feature-title">
                              ...
                              <div class="feature last">
                                 ...
                                 <img width="370" height="280" src="assets\images\about-column-3.jpeg" class="attachment-370x370 size-370x370 wp-post-image" alt="">
                                 </a>
                                 <h3 class="feature-title">
                     ...
                     <div class="pizzaro-basics ">
                        <figure>
                           <img width="1920" height="418" src="assets\images\about-banner.jpeg" alt="">
                        </figure>
                        <div class="container">
                           <div class="row">
                              <div class="blocks">
