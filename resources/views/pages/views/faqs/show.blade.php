      ...
      <div class="content ">
            ...
            <div class=" container p-l-0 p-r-0   container-fixed-lg sm-p-l-0 sm-p-r-0">
              <div class="inner">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Counselings</li>
                </ol>
                <!-- END BREADCRUMB -->
                <div class="row">
                  ...
                  <div class="col-xl-5 col-lg-6 ">
                    ...
                    <div class="card card-transparent">
                      <div class="card-header ">
                        <div class="card-title">Counselings
                        </div>
                      </div>
                      <div class="card-block">
                        <h3>Herramienta para crear Counselings</h3>
                        ...
                        <br>
                        <small>{{ link_to_route('manager.counselings.create', __('Añadir'), [], ['class' => 'btn btn-info btn-cons']) }}</small>
                      </div>
                    </div>
                    <!-- END card -->
                  </div>
          ...
          <div class=" no-padding container-fixed-lg bg-white">
            <div class="container">
              ...
              <div class="card card-transparent">
                <div class="card-header ">
                  <div class="card-title">Listado Counselings
                  </div>
                ...
                <div class="card-block">
                  @include ('manager/views/counselings/_list')                  
                </div>
              </div>
            </div>
          </div>
