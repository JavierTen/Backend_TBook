...
<div class="pizzaro-breadcrumb">
                  <nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
                     <a href="index-1.html">Home</a><span class="delimiter"><i class="po po-arrow-right-slider"></i></span>
                    ...
                    <div class="product type-product status-publish has-post-thumbnail product_cat-pizza pa_food-type-veg first instock shipping-taxable purchasable product-type-variable has-children">
                        ...
                        <div class="single-product-wrapper">
                           <div class="product-images-wrapper">
                              <div class="images">
                                 <a href="assets\images\single-product\1.jpeg" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto[product-gallery]">
                                 <img width="600" height="600" src="assets\images\single-product\1.jpeg" class="attachment-shop_single size-shop_single wp-post-image" alt="">
                                 </a>
                              </div>
                           </div>
                           ...
                           <div class="summary entry-summary">
                            ...
                            <!-- AddToAny END -->
                              <div class="thumbnails columns-4">
                                 <a href="assets\images\single-product\1.jpeg" class="zoom first" title="" data-rel="prettyPhoto[product-gallery]">
                                 <img width="180" height="180" src="assets\images\single-product\1.jpeg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                 </a>
                                 <a href="assets\images\single-product\2.jpeg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
                                 <img width="180" height="180" src="assets\images\single-product\2.jpeg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                 </a>
                              </div>
                           </div>
                           <!-- .summary -->
                                    ...
                                    <div class="ingredients">
                                       ...
                                       <div class="food-items">
                                          <div class="items col-md-4 col-xs-12 col-sm-4">
                                             <span class="image"><img src="assets\images\single-product\3.jpeg" alt=""></span>
                                             <span class="info">100% Whole Milk<br>Mozarella</span>
                                          </div>
                                          <div class="items col-md-4 col-xs-12 col-sm-4">
                                             <span class="image"><img src="assets\images\single-product\4.jpeg" alt=""></span>
                                             <span class="info">Ecological<br>Mushrooms</span>
                                          </div>
                                          <div class="items col-md-4 col-xs-12 col-sm-4">
                                             <span class="image"><img src="assets\images\single-product\5.jpeg" alt=""></span>
                                             <span class="info">Zesty Pepperoni</span>
                                          </div>
                                          <div class="items col-md-4 col-xs-12 col-sm-4">
                                             <span class="image"><img src="assets\images\single-product\6.jpeg" alt=""></span>
                                             <span class="info">Seasoned Italian<br>Sausage</span>
                                          </div>
                                          <div class="items col-md-4 col-xs-12 col-sm-4">
                                             <span class="image"><img src="assets\images\single-product\7.jpeg" alt=""></span>
    ...
    <script src="{{ asset('assets\js\plugin\jquery-2.2.4.min.js') }}" type="text/javascript"></script> 
                ...
                $(document).on('click', '.quantity .plus, .quantity .minus', function (e) {
                                ...
                                e.preventDefault();
                                var $purchase = $(this).closest('.quantity').find('.purchase');
                                ...
                                $("#updatePurchases").find("input[name='identifierShopping']").val(purchase);             
                                $("#updatePurchases").find("input[name='identifierQuantity']").val(cant); 
                                $("#detailsShoppings").find("input[name='identifierQuantity']").val(cant);
                 ...
                 function updatePurchases() {
                            ...
                            var shopping = $("#updatePurchases").find("input[name='identifierShopping']").val();   
                            var quantity = $("#updatePurchases").find("input[name='identifierQuantity']").val();
                ...
                <script src="{{ asset('assets\js\show.js') }}" type="text/javascript"></script> 
                <script src="{{ asset('assets\js\shopping.js') }}" type="text/javascript"></script>      
                <script src="{{ asset('assets\js\purchase.js') }}" type="text/javascript"></script>    
