                            ...
                            <li class="product">
                                                @if ($featured->hasThumbnail())   
                                                  <figure class="product-image-container">
                                                        <a href="{{ route('products.show', array($featured->slug)) }}">
                                                            <img src="/assets/images/products/{{ $featured->thumbnail()->filename }}" alt="{{ $featured->sku }}">
                                                        </a>
                                                  </figure>
                                                @endif                                                
                                                <div>
                                                    ...
                                                    <h4 class="product-title">                                                        
                                                        <a href="{{ route('products.show', array($featured->slug)) }}">{{ $featured->name }}</a>
                                                    </h4>
