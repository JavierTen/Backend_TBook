                           ...
                           <ul class="products">
                                 ...
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets\images\products\p1.jpeg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="13" title="13"></a>
                                       </div>
                              ...
                              <li class="product pa_food-type-veg last">
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets\images\products\p4.jpeg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="13" title="13"></a>
                                       </div>
                                       <div class="product-content-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                                             <h3>Trio Cheese</h3>
                              ...
                              <li class="product pa_food-type-meat first">
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets\images\products\p5.jpeg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="13" title="13"></a>
                                       </div>
                                       <div class="product-content-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                              ...
                              <li class="product last">
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets\images\products\p6.jpeg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="13" title="13"></a>
                                       </div>
                                       <div class="product-content-wrapper">
                                          <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
